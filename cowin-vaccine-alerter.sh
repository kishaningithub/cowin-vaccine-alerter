...
cat dose-1-result.txt | xargs -I {} curl -fLG "https://api.telegram.org/${TELEGRAM_BOT_TOKEN}/sendMessage" --data-urlencode "chat_id=${TELEGRAM_BOT_CHAT_ID}" --data-urlencode "text={}"